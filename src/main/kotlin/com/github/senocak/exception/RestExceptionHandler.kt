...
class RestExceptionHandler {
    ...
    fun handleMaxUploadSizeExceededException(ex: MaxUploadSizeExceededException): ResponseEntity<Any> =
        generateResponseEntity(httpStatus = HttpStatus.BAD_REQUEST, omaErrorMessageType = OmaErrorMessageType.BASIC_INVALID_INPUT,
            variables = arrayOf(ex.cause?.cause?.message))
